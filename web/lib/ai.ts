...
export function aiConfig(): AIConfig {
  ...
  return {
    ...
    baseUrl,
    provider,
    fastModel: process.env.LLM_FAST_MODEL || (or ? "google/gemini-2.5-flash" : legacyModel),
    reasoningModel: process.env.LLM_REASONING_MODEL || (or ? "anthropic/claude-sonnet-4.5" : legacyModel),
